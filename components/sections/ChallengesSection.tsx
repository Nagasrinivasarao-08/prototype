  ...
  return (
    <section className="py-20 lg:py-28 bg-[#F5F5F7] text-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimateIn variants={fadeUp} className="text-center mb-16 space-y-5">
        ...
        {/* 3-column card grid — staggered reveal */}
        <AnimateStagger
        ...
        >
          {CHALLENGES.map((item, idx) => (
            <AnimateStaggerItem key={idx} variants={fadeUp}>
              <motion.div
                className="bg-white rounded-2xl overflow-hidden border border-slate-200/80 shadow-sm flex flex-col justify-between h-full"
                whileHover={{ y: -6, boxShadow: "0 16px 40px -12px rgba(0,0,0,0.15)" }}
