...
const ILLUSTRATIONS = [
  /* 1 — Cost-Effectiveness: coins / value bag */
  ...
  /* 2 — Proven Competence: trophy / star */
  ...
  /* 4 — Flexible Scalability: scaling arrows */
  ...
  /* 5 — Client Partnership: handshake */
  ...
  /* 6 — Results-Driven: target / bullseye */
  ...
  return (
    <section id="about" className="py-20 lg:py-28 bg-[#F5F5F7] text-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Centered header — CodeDale style */}
        ...
        {/* 3×2 grid — large illustration top, title, description */}
